...
import com.example.chenyunpeng.myyoho.bean.BannerBean;
...
public class MyBanner extends RelativeLayout {
    ...
    private void init() {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, Dp2Px.dp2px(20));
